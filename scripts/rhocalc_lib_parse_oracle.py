...
def main() -> int:
    ...
    cases = [
        (
            "pure-interface",
            '(rho-file->canon "tests/rhocalc/pure_interface.rho")',
            "rho",
            "tests/rhocalc/pure_interface.rho",
            2,
            "yes",
        ),
        (
            "shadowing",
            '(rho-file->canon "tests/rhocalc/interface_shadowing.rho")',
            "rho",
            "tests/rhocalc/interface_shadowing.rho",
            3,
            "yes",
        ),
        (
            "commented-quote-inner",
            '(rho-file->canon "tests/rhocalc/interface_quote_inner_binder_restores_scope.rho")',
            "rho",
            "tests/rhocalc/interface_quote_inner_binder_restores_scope.rho",
            2,
            "yes",
        ),
        (
            "interface-name-output",
            '(rho-file->canon "tests/rhocalc/interface_name_output.rho")',
            "rho",
            "tests/rhocalc/interface_name_output.rho",
            1,
            "yes",
        ),
        (
            "interface-open-name-variable",
            '(rho-file->canon "tests/rhocalc/interface_open_name_variable.rho")',
            "rho",
            "tests/rhocalc/interface_open_name_variable.rho",
            1,
            "yes",
        ),
        (
            "quote-seals-outer-binder",
            '(rho-file->canon "tests/rhocalc/interface_quote_seals_outer_binder.rho")',
            "rho",
            "tests/rhocalc/interface_quote_seals_outer_binder.rho",
            1,
            "yes",
        ),
        (
        ...
        (
            "interface-name-output-core-witness",
            '(rho-file->canon "tests/rhocalc/interface_name_output.rho")',
            "mrho",
        ...
        (
            "interface-name-output-vs-name-pass-negative",
            '(rho-file->canon "tests/rhocalc/interface_name_output.rho")',
            "mrho",

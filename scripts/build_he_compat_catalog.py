...
BROAD_MODULE_RESOLUTION_NOTES: dict[str, dict[str, Any]] = {
    "tests/test_import_cycle.metta": {
        ...
        "rule_ids": ["interface.module-import"],
    },
    "tests/test_import_fresh_name_conformance.metta": {
        ...
        "rule_ids": ["interface.module-import", "interface.atomspace-assertions"],
    },
    ...
    "tests/test_import_parse_failure.metta": {
        ...
        "rule_ids": ["interface.module-import", "result.error-shape"],
    },
...
BROAD_LOCAL_LIBRARY_IMPORT_PATHS = {
    ...
    "tests/test_list_interface.metta",
    "tests/test_lts_he_interface.metta",
    "tests/test_lts_interface.metta",
    "tests/test_math_lib_interface.metta",
...
TRACK_A_RULE_LANES = {
    "interface.eval-bang": "supporting-interface",
    "interface.atomspace-assertions": "supporting-interface",
    ...
    "minimal.evalc-context-space": "supporting-interface",
    "minimal.chain": "reduction-span",
    "minimal.match": "supporting-interface",
    "minimal.unify": "supporting-interface",
    "minimal.collapse-superpose": "reduction-span",
    "minimal.cons-decons": "supporting-interface",
    "minimal.function-return": "reduction-span",
    "eval.applicative-arguments": "supporting-interface",
    "eval.grounded-dispatch": "supporting-interface",
    "nondet.visible-bag": "reduction-span",
    "profile.docs": "supporting-interface",
    "profile.interface-policy": "spatial-policy",
    "interface.module-import": "spatial-policy",
    "interface.module-inventory": "spatial-policy",
    "interface.native-space": "spatial-policy",
    "grounded.numeric-exact": "supporting-interface",
}
...
A2_AUTHORITY_NOTES = {
    ...
    "result.empty-zero": (
        ...
        "This is a reduction-span rule in Track A, not a host-policy interface."
    ),
}

SPEC_RULE_CAPACITIES: list[dict[str, Any]] = [
    {
        "id": "interface.eval-bang",
    ...
    {
        "id": "interface.atomspace-assertions",
        ...
        "native_contract_ids": ["profile-interface-policy-table"],
        "status": "partial",
    },
    {
    ...
    },
    {
        ...
        "oslf_refs": [OSLF_ANCHORS["language_def"]],
        "native_contract_ids": ["constructor-arity-interface"],
        "status": "covered",
    },
    {
    ...
    {
        "id": "profile.docs",
        "title": "Profile-aware documentation interface",
        "official_spec_refs": ["he_metta_official_specs.md:profile/lang interfaces"],
        "lean_language_def_refs": [],
        "oslf_refs": [],
        "native_contract_ids": [
            "get-doc-respects-profile-interface",
            "he-compat-reproduces-rust-get-doc-arity",
        ],
        "status": "covered",
    },
    {
        "id": "profile.interface-policy",
        "title": "Language/profile interface availability",
        "official_spec_refs": ["he_metta_official_specs.md:profile/lang interfaces"],
        "lean_language_def_refs": [],
        "alignment_note": (
            "Current HELanguageDef models core HE evaluation rules, not the "
            "CeTTa profile/lang interface inventory. This rule is tracked by "
    ...
    {
        "id": "interface.module-import",
        "title": "Module import/include resolution",
        "official_spec_refs": ["he_metta_official_specs.md:module/import interfaces"],
        "lean_language_def_refs": [],
        "alignment_note": (
            "Module/import resolution is currently a runtime/meta-interface, not "
            "a first-class HELanguageDef rule family. The rule index keeps it "
            "visible as a formal-he policy interface and a he-compat boundary."
        ),
        "oslf_refs": [],
        "native_contract_ids": [
            "profile-interface-policy-table",
            "module-import-policy-evidence-shape",
        ],
        "status": "partial",
    },
    {
        "id": "interface.module-inventory",
        "title": "Module inventory and visible module tree",
        "official_spec_refs": ["he_metta_official_specs.md:profile/lang module interfaces"],
        "lean_language_def_refs": [],
        "alignment_note": (
            ...
            "interface until we model module visibility at the LanguageDef/space "
            "layer."
        ),
        "oslf_refs": [],
        "native_contract_ids": [
    ...
    {
        "id": "interface.native-space",
        "title": "Native space operations and space-kind extensions",
        "official_spec_refs": ["he_metta_official_specs.md:space operation interfaces"],
    ...
    },
    {
        ...
        "official_spec_refs": ["he_metta_official_specs.md:grounded arithmetic interfaces"],
...
def track_a_rule_lane(rule_id: str) -> str:
    return TRACK_A_RULE_LANES.get(rule_id, "supporting-interface")
...
def infer_spec_rule_ids(row: dict[str, Any]) -> list[str]:
    ...
    if "profile" in text or "interface" in text or "compat" in text or "extended" in text:
        ids.add("profile.interface-policy")
    if "import" in text or "include" in text or "module" in text:
        ids.add("interface.module-import")
    if (
        ...
        ids.add("interface.module-inventory")
    if any(
        ...
        ids.add("interface.native-space")
...
def enrich_case_with_rule_map(row: dict[str, Any]) -> dict[str, Any]:
    ...
    for rule_id in rule_ids:
        ...
        rule_lanes.add(str(cap.get("track_a_relation_lane", "supporting-interface")))
...
BROAD_CATEGORY_DETAILS: dict[str, dict[str, str]] = {
    ...
    "local-library-or-import-extension": {
        ...
        "recommended_action": (
            ...
            "gains the module/import interface."
        ),
    },
    ...
    "module-inventory-environment-diff": {
        "kind": "environment-interface-gap",
...
def broad_rule_ids(row: dict[str, Any], category: str) -> list[str]:
    ...
    if category in {"local-library-or-import-extension", "module-resolution-diff"}:
        ...
        ids.update(["interface.module-import", "interface.module-inventory", "profile.interface-policy"])
        ...
        ids.update(["interface.eval-bang", "nondet.visible-bag"])
    known = capacity_by_id()
    return sorted(rule_id for rule_id in ids if rule_id in known)
...
def main() -> int:
    ...
    payload = {
        ...
        "subject": "CeTTa HE-compatible runtime interface",
        "no_runtime_trace_or_certificate_interface": True,
        "semantic_indexing": {
        ...
        "profile_policy": {
            ...
            "he_compat": {
                "scope": (
                    ...
                    "interface quirks; formal/spec-faithful behavior belongs to --lang "
                    "he / --profile he."
                ),
            },
        },

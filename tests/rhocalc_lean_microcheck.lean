...
theorem costInterface_semantic_subst_body_ignores_payload :
...
theorem costInterface_continued_contract_records_intrinsic_spent :
...
theorem costInterface_continued_contract_spent_shadow :
    rhoLedgerShadow
      ((rhoContinuedCutPresentation.contractWrapped
          costChannel costChannel
          { term := costBodyTerm, grade := zeroCostGrade }
...
theorem costInterface_continued_contract_spent_syntax_eq_shadow :
...
theorem costInterface_continued_contract_left_term :
    (rhoContinuedCutPresentation.contractWrapped
        costChannel costChannel
        { term := costBodyTerm, grade := zeroCostGrade }
  ...
  calc
    ...
    _ = costBodyTerm := by
          exact costInterface_semantic_subst_body_ignores_payload

theorem costInterface_continued_contract_right_term :
    (rhoContinuedCutPresentation.contractWrapped
        costChannel costChannel
        { term := costBodyTerm, grade := zeroCostGrade }
...
theorem costInterface_continued_contract_spent_wellFormed :
...
theorem costInterface_continued_contract_left_grade :
    (rhoContinuedCutPresentation.contractWrapped
        costChannel costChannel
        { term := costBodyTerm, grade := zeroCostGrade }
...
theorem costInterface_continued_contract_right_grade :
    (rhoContinuedCutPresentation.contractWrapped
      costChannel costChannel
      { term := costBodyTerm, grade := zeroCostGrade }
...
theorem costInterface_continued_contract_spent_and_left_term :
    let step :=
      rhoContinuedCutPresentation.contractWrapped
        costChannel costChannel
        { term := costBodyTerm, grade := zeroCostGrade }
  ...
  constructor
  · exact costInterface_continued_contract_records_intrinsic_spent
  · constructor
    · exact costInterface_continued_contract_spent_shadow
    · exact costInterface_continued_contract_left_term

theorem costInterface_continued_contract_preserves_wrapped_structure :
  ...
  · exact costInterface_continued_contract_left_term
  · constructor
    · exact costInterface_continued_contract_right_term
    · constructor
      · exact costInterface_continued_contract_left_grade
      · constructor
        · exact costInterface_continued_contract_right_grade
        · exact costInterface_continued_contract_spent_wellFormed

theorem costInterface_continued_contract_preserves_direct_witness :
    let step : Mettapedia.GSLT.Meredith.AccountedCutStep Pattern RhoLedger RhoLedger :=
      rhoContinuedCutPresentation.contractWrapped
        costChannel costChannel
        { term := costBodyTerm, grade := zeroCostGrade }
  ...
  have hdirect :=
    rhoContinuedCutPresentation_preserves_direct_witness
      ...
      { term := costBodyTerm, grade := zeroCostGrade }
      { term := costPayloadTerm, grade := zeroCostGrade }
  have hwrap := costInterface_continued_contract_preserves_wrapped_structure
  constructor
  · exact hwrap.1
  · constructor
    · calc
...
theorem costInterface_continued_no_leak :
    let step : Mettapedia.GSLT.Meredith.AccountedCutStep Pattern RhoLedger RhoLedger :=
      rhoContinuedCutPresentation.contractWrapped
        costChannel costChannel
        { term := costBodyTerm, grade := zeroCostGrade }
...
theorem costInterface_continued_totalAction_shadow_eq_totalCost_oneStepPath :
    rhoLedgerShadow
...
theorem costInterface_continued_totalAction_spentSyntax_eq_totalCost_oneStepPath :
    rhoSpentSyntaxAccount
      (rhoLedgerToSpentSyntax
        (totalAction rhoIntrinsicLedgerAction
          (continuedCommPath costChannel costPayloadTerm costBodyTerm))) =
...
theorem costInterface_continued_totalAction_temporalLength_eq_path_length :
    (totalAction rhoIntrinsicLedgerAction
...
theorem costInterface_continued_traceAccount_eq_totalCost_oneStepPath :
...
theorem costInterface_continued_trace_ticks_is_one :
    traceAccount (S := rhoGSLT) (A := Nat) (k := 2)
...
theorem costInterface_continued_trace_ticks_eq_path_length :
    traceAccount (S := rhoGSLT) (A := Nat) (k := 2)
...
theorem costInterface_two_step_traceAccount_eq_totalCost :
    traceAccount (S := rhoGSLT) (A := Nat) (k := 2)
...
theorem costInterface_two_step_totalAction_shadow_eq_totalCost :
...
theorem costInterface_two_step_totalAction_spentSyntax_eq_totalCost :
    rhoSpentSyntaxAccount
...
theorem costInterface_two_step_totalAction_publicSpentSyntax_width_eq_spatialCard :
    rhoSpentSyntaxWidth
      (rhoLedgerToSpentSyntax (totalAction rhoIntrinsicLedgerAction continuedTwoStepPath)) =
...
theorem costInterface_two_step_totalAction_publicSpentSyntax_ticks_eq_path_length :
    rhoSpentSyntaxTicks
      (rhoLedgerToSpentSyntax (totalAction rhoIntrinsicLedgerAction continuedTwoStepPath)) =
        continuedTwoStepPath.length := by
  simpa using continuedTwoStepTotalAction_publicSpentSyntax_ticks_eq_length

theorem costInterface_two_step_totalAction_publicSpentSyntax_width_eq_totalCost_zero :
    rhoSpentSyntaxWidth
      (rhoLedgerToSpentSyntax (totalAction rhoIntrinsicLedgerAction continuedTwoStepPath)) =
...
theorem costInterface_two_step_totalAction_publicSpentSyntax_ticks_eq_totalCost_one :
    rhoSpentSyntaxTicks
      (rhoLedgerToSpentSyntax (totalAction rhoIntrinsicLedgerAction continuedTwoStepPath)) =
...
theorem costInterface_two_step_totalAction_publicSpentSyntax_modulus :
    rhoSpentSyntaxWidth
      (rhoLedgerToSpentSyntax (totalAction rhoIntrinsicLedgerAction continuedTwoStepPath)) =
...
theorem costInterface_two_step_totalAction_shadow_eq_traceAccount :
    rhoLedgerShadow (totalAction rhoIntrinsicLedgerAction continuedTwoStepPath) =
      traceAccount (S := rhoGSLT) (A := Nat) (k := 2) continuedTwoStepTrace := by
  simpa using continuedTwoStepTotalAction_shadow_eq_traceAccount

theorem costInterface_two_step_totalAction_temporalLength_eq_path_length :
...
theorem costInterface_two_step_directSpent_toLedger :
...
theorem costInterface_two_step_directSpent_ticks_eq_path_length :
    rhoSpentSyntaxTicks continuedTwoStepDirectSpent.toPattern =
      continuedTwoStepPath.length := by
  simpa using continuedTwoStepDirectSpent_ticks_eq_length

theorem costInterface_two_step_directSpent_eq_append_steps :
...
theorem costInterface_two_step_directSpent_eq_traceSteps :
    continuedTwoStepDirectSpent =
      RhoDirectStack.append
...
theorem costInterface_two_step_directSpentTrace_eq_traceSteps :
...
theorem costInterface_two_step_directSpentTrace_account_eq_publicSpentSyntax :
    rhoSpentSyntaxAccount
...
theorem costInterface_two_step_directSpentTrace_width_eq_totalCost_zero :
...
theorem costInterface_two_step_directSpentTrace_ticks_eq_totalCost_one :
...
theorem costInterface_two_step_directSpentTrace_modulus :
    rhoSpentSyntaxWidth (rhoIntrinsicDirectSpentTrace continuedTwoStepPath).toPattern =
      totalCost rhoIntrinsicCostMap continuedTwoStepPath 0 ∧
      rhoSpentSyntaxTicks (rhoIntrinsicDirectSpentTrace continuedTwoStepPath).toPattern =
        totalCost rhoIntrinsicCostMap continuedTwoStepPath 1 ∧
...
theorem costInterface_two_step_publicSpentSyntax_no_leak_append :
    rhoSpentSyntaxAccount
      (rhoLedgerToSpentSyntax
        (totalAction rhoIntrinsicLedgerAction continuedTwoStepPath)) =
          rhoSpentSyntaxAccount
...
theorem costInterface_two_step_directSpentTrace_no_leak_append :
    rhoSpentSyntaxAccount
      (rhoIntrinsicDirectSpentTrace continuedTwoStepPath).toPattern =
        rhoSpentSyntaxAccount
...
theorem costInterface_two_step_publicSpentSyntax_semantics :
    rhoSpentSyntaxAccount
      (rhoLedgerToSpentSyntax
        (totalAction rhoIntrinsicLedgerAction continuedTwoStepPath)) =
...
theorem costInterface_two_step_directSpentTrace_semantics :
...
theorem costInterface_two_step_directSpentTrace_toPublicPattern_eq_publicSpentSyntax :
    (rhoIntrinsicDirectSpentTrace continuedTwoStepPath).toPublicPattern =
      rhoLedgerToSpentSyntax
        (totalAction rhoIntrinsicLedgerAction continuedTwoStepPath) := by
  simpa using continuedTwoStepDirectSpentTrace_toPublicPattern_eq_publicSpentSyntax

theorem costInterface_two_step_publicSpentSyntax_modulus_reducesN :
    rhoSpentSyntaxWidth
      (rhoLedgerToSpentSyntax
        (totalAction rhoIntrinsicLedgerAction
...
theorem costInterface_two_step_directSpentTrace_modulus_reducesN :
    rhoSpentSyntaxWidth
      (rhoIntrinsicDirectSpentTrace
...
theorem costInterface_two_step_first_reducesN_path_eq :
...
theorem costInterface_two_step_second_reducesN_path_eq :
    rhoRewritePathOfReducesN continuedTwoStepSecondReducesN =
      oneStepPath (S := rhoGSLT) continuedTwoStepSecondStep := by
  simpa using continuedTwoStepSecondReducesN_path_eq

theorem costInterface_two_step_publicSpentSyntax_semantics_reducesN :
    rhoSpentSyntaxAccount
      (rhoLedgerToSpentSyntax
        (totalAction rhoIntrinsicLedgerAction
          (rhoRewritePathOfReducesN continuedTwoStepReducesN))) =
...
theorem costInterface_two_step_directSpentTrace_semantics_reducesN :
    (rhoIntrinsicDirectSpentTrace
...
theorem costInterface_two_step_publicSpentSyntax_no_leak_reducesN_concat :
    rhoSpentSyntaxAccount
      (rhoLedgerToSpentSyntax
        (totalAction rhoIntrinsicLedgerAction
...
theorem costInterface_two_step_directSpentTrace_no_leak_reducesN_concat :
    rhoSpentSyntaxAccount
      (rhoIntrinsicDirectSpentTrace
        (rhoRewritePathOfReducesN
...
theorem costInterface_two_step_publicSpentSyntax_semantics_reducesN_concat :
    rhoSpentSyntaxAccount
      (rhoLedgerToSpentSyntax
        (totalAction rhoIntrinsicLedgerAction continuedTwoStepPath)) =
          rhoSpentSyntaxAccount
...
theorem costInterface_two_step_directSpentTrace_semantics_reducesN_concat :
    (rhoIntrinsicDirectSpentTrace continuedTwoStepPath).SurfaceLike ∧
      (rhoIntrinsicDirectSpentTrace continuedTwoStepPath).toLedger =
        totalAction rhoIntrinsicLedgerAction continuedTwoStepPath ∧
      (rhoIntrinsicDirectSpentTrace continuedTwoStepPath).toPublicPattern =
...
theorem costInterface_two_step_semantic_bridge :
    traceAccount (S := rhoGSLT) (A := Nat) (k := 2)
      continuedTwoStepTrace =
        totalCost rhoIntrinsicCostMap

...
static const CettaSurfacePolicy CETTA_SURFACE_POLICIES[] = {
    ...
    {"_minimal-foldl-until-atom", CETTA_PROFILE_MASK_HE_EXTENDED_PLUS, "clean_primary_extension"},
    ...
    {"member-atom?", CETTA_PROFILE_MASK_HE_EXTENDED_PLUS, "clean_primary_extension"},
    {"subset-atom?", CETTA_PROFILE_MASK_HE_EXTENDED_PLUS, "clean_primary_extension"},
    {"same-set-atom?", CETTA_PROFILE_MASK_HE_EXTENDED_PLUS, "clean_primary_extension"},
    {"galois-closure-atom", CETTA_PROFILE_MASK_HE_EXTENDED_PLUS, "clean_primary_extension"},
    {"galois-intents-atom", CETTA_PROFILE_MASK_HE_EXTENDED_PLUS, "clean_primary_extension"},
    {"galois-canonical-basis-atom", CETTA_PROFILE_MASK_HE_EXTENDED_PLUS, "clean_primary_extension"},
    {"galois-canonical-basis-next-atom", CETTA_PROFILE_MASK_HE_EXTENDED_PLUS, "clean_primary_extension"},
    {"wm-fca-index-columns-atom", CETTA_PROFILE_MASK_HE_EXTENDED_PLUS, "clean_primary_extension"},
    {"wm-fca-binary-rows-columns-atom", CETTA_PROFILE_MASK_HE_EXTENDED_PLUS, "clean_primary_extension"},
    {"wm-fca-binary-cell-status-atom", CETTA_PROFILE_MASK_HE_EXTENDED_PLUS, "clean_primary_extension"},
    {"wm-fca-binary-query-batch-atom", CETTA_PROFILE_MASK_HE_EXTENDED_PLUS, "clean_primary_extension"},
    {"wm-fca-binary-event-columns-atom", CETTA_PROFILE_MASK_HE_EXTENDED_PLUS, "clean_primary_extension"},
    {"wm-fca-binary-event-cell-evidence-atom", CETTA_PROFILE_MASK_HE_EXTENDED_PLUS, "clean_primary_extension"},
    {"wm-fca-binary-event-query-batch-atom", CETTA_PROFILE_MASK_HE_EXTENDED_PLUS, "clean_primary_extension"},
    {"wm-fca-binary-event-observation-count-atom", CETTA_PROFILE_MASK_HE_EXTENDED_PLUS, "clean_primary_extension"},
    {"wm-fca-evidence-layer-columns-atom", CETTA_PROFILE_MASK_HE_EXTENDED_PLUS, "clean_primary_extension"},
    {"wm-fca-evidence-layer-cell-evidence-atom", CETTA_PROFILE_MASK_HE_EXTENDED_PLUS, "clean_primary_extension"},
    {"wm-fca-evidence-layer-query-batch-atom", CETTA_PROFILE_MASK_HE_EXTENDED_PLUS, "clean_primary_extension"},
    {"wm-fca-evidence-layer-observation-count-atom", CETTA_PROFILE_MASK_HE_EXTENDED_PLUS, "clean_primary_extension"},
    {"subset-cover-relations-atom", CETTA_PROFILE_MASK_HE_EXTENDED_PLUS, "clean_primary_extension"},
    ...
    {"foldl-until-atom", CETTA_PROFILE_MASK_HE_EXTENDED_PLUS, "clean_primary_extension"},

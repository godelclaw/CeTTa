...
#define CETTA_BUILTIN_SYMBOLS(X) \
    ...
    X(lib_system_os, "__cetta_lib_system_os") \
    X(lib_system_random_base64url_no_pad, "__cetta_lib_system_random_base64url_no_pad") \
    ...
    X(lib_shell_shlex_join, "__cetta_lib_shell_shlex_join") \
    ...
    X(lib_patch_inspect_streaming, "__cetta_lib_patch_inspect_streaming") \

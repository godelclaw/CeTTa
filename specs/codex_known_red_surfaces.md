...
Last updated: 2026-05-22 on branch `exp/codex` after the fieldful
tool_search discovery pass.
...
- `scripts/check_codex_surfaces.sh` exits nonzero only for the two deferred
  surfaces documented below. Rechecked after the fieldful `tool_search`
  discovery pass.
